...
pub enum TiSB {
    ...
    Longitude,
    NIC,
    RadiusOfContainment, // Original field is "rc". I think I'm right in assuming this is "radius of containment"
    NACp,
    NACv,
    SIL,
    SILType,
...
impl Serialize for TiSB {
        ...
        S: serde::Serializer,
    {
        match *self {
            ...
            TiSB::RadiusOfContainment => serializer.serialize_str("rc"),
...
impl fmt::Display for TiSB {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            TiSB::RadiusOfContainment => write!(f, "Radius of Containment"),
...
impl TryFrom<String> for TiSB {
    ...
    fn try_from(field: String) -> Result<Self, Self::Error> {
        match field.as_str() {
            ...
            "nic" => Ok(TiSB::NIC),
            "rc" => Ok(TiSB::RadiusOfContainment),
            "nac_p" => Ok(TiSB::NACp),
            "nac_v" => Ok(TiSB::NACv),
            "sil" => Ok(TiSB::SIL),
