...
mod tests {
    ...
    fn test_adsb_beast_parsing_input() {
        ...
        let raw_frames = [
            0x1a_u8, 0x31, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1a, 0x31, 0x0, 0x0, 0x0,
            0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1a, 0x31, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
            0x1a, 0x31, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1a, 0x31, 0x0, 0x0, 0x0,
            0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1a, 0x32, 0x0, 0x3e, 0x95, 0x68, 0x61, 0x57, 0x19, 0x2,
            0xe1, 0x94, 0x10, 0xfa, 0xf5, 0x48, 0x1a, 0x33, 0x0, 0x3e, 0x95, 0x68, 0x8c, 0x89,
    ...
    fn test_buffer_left_over_reassembly() {
        ...
        let raw_frames = [
            0x1A_u8, 0x33, 0x01, 0x9B, 0x52, 0x68, 0xF7, 0xAE, 0x2F, 0x8D, 0xA6, 0x1F, 0x0E, 0x99,
            0x15, 0x31, 0x19, 0xB0, 0x04, 0x13, 0x2C, 0xE9, 0xFC, 0x1A, 0x32, 0x01, 0x9B, 0x52,
            0x69, 0x1A, 0x1A, 0xE3, 0xB3, 0x02, 0x00, 0x03, 0xA0,
        ];
        ...
        let raw_frames = [
            0xE3_u8, ,
        ];
    ...
    fn test_double_ends_in_message_and_end_of_frame() {
        ...
        let raw_frame = [
            0x1A_u8, ,
        ];
